...
export const initialSettings: SchoolSettings = {
  ...
  tiktok_url: 'https://tiktok.com/@misyuriyah_pebatan',
  twitter_url: 'https://x.com/misyuriyah',
  telegram_url: 'https://t.me/misyuriyahpebatan',
  threads_url: 'https://threads.net/@misyuriyah_pebatan',
  whatsapp_channel_url: 'https://whatsapp.com/channel/0029VaMisyuriyahPebatan',
  show_facebook: true,
  show_instagram: true,
  show_youtube: true,
  show_tiktok: true,
  ...
  social_media_title: 'Media Sosial Resmi MI Syuriyah Pebatan',
  social_media_description: 'Ikuti akun media sosial resmi madrasah untuk mendapatkan dokumentasi kegiatan, kabar prestasi siswa, serta informasi terkini.',
